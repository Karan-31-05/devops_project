...
# =============================================================================
# Set these to enable Moodle integration:
#   MOODLE_BASE_URL  = your Moodle site URL (e.g. https://moodle.yourcollege.edu)
#   MOODLE_API_TOKEN = Web Service token from Moodle admin
# Leave empty to disable (signals become no-ops, views show "not configured")
MOODLE_BASE_URL = os.environ.get('MOODLE_BASE_URL', 'https://cdp.moodlecloud.com')
MOODLE_API_TOKEN = os.environ.get('MOODLE_API_TOKEN', '')
MOODLE_API_TIMEOUT = 60  # seconds
MOODLE_VERIFY_SSL = False  # Temporarily disabled for testing
